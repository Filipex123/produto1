...
CREATE TABLE labirinto( nome VARCHAR(25) NOT NULL, identificador VARCHAR(100) NOT NULL, dataCriacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, dataEdicao TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP, conteudo LONGTEXT NOT NULL, CONSTRAINT PK_lab PRIMARY KEY (nome,identificador) );
...
SELECT nome, identificador, dataCriacao, dataEdicao FROM labirinto;
